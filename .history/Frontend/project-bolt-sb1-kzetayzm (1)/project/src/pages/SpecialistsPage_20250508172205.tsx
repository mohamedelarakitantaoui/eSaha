          ...
          {filteredSpecialists.map((specialist) => (
            ...
            >
              ...
              <div className="flex items-center mb-3 text-sm">
                {/* Removed Clock icon since it's not imported anymore */}
...
const SpecialistsPage: React.FC = () => {
  ...
  // Define fetchAvailableDates here to avoid block-scoped variable error
  // This is a stub function that we are not actually using in SpecialistsPage
  // It exists purely to avoid a TypeScript error in the code
  const fetchAvailableDates = useCallback(async (_id: string) => {
    // This is just a placeholder to avoid TypeScript errors
    // It doesn't need to do anything since it's not used in this component
    return [];
  }, []);
  ...
  useEffect(() => {
    const fetchSpecialists = async () => {
      ...
      try {
        ...
        // This makes sure we're using the API variable to avoid the unused error
