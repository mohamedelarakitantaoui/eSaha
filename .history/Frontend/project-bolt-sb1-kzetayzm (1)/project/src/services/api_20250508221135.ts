...
// Simple base64 encoded gray placeholder image - this is a small 300x300 gray box with no external dependencies
const placeholderImageBase64 =
  'data:image/png;base64,';
...
// Mock specialists data with base64 placeholder images
  ...
  chat: {
    ...
    createSession: async (
      ...
      try {
        ...
        if (!response.ok) {
          const errorData = await safelyParseResponse(response);
          const errorText =
  ...
  specialists: {
    ...
    getSpecialistById: async (
      ...
      try {
        ...
        const foundSpecialist = mockSpecialistsData.find(
          (s) => s.id === specialistId
        );
        if (!foundSpecialist) {
    ...
    getSpecialistAvailability: async (
      ...
      try {
        ...
        // Use the imported mockUtils to generate availability data
        const mockAvailability: SpecialistAvailability[] = [
          {
            id: '1',
     ...
     * This function uses mock data and doesn't require a token
     */
    getAvailableTimeSlots: async (
      ...
      try {
        ...
        // Use the imported mockUtils function
  ...
  appointments: {
    ...
    getAllAppointments: async (token: string): Promise<Appointment[]> => {
      try {
        ...
        console.log(`Get appointments response status: ${response.status}`);
    ...
    bookAppointment: async (
      ...
      try {
        ...
        // Create a complete appointment object with default values for optional fields
        const completeAppointmentData = {
          ...appointmentData,
          title:
            appointmentData.title || `Appointment on ${appointmentData.date}`,
          type: appointmentData.type || 'therapy',
          reminder_time: appointmentData.reminder_time || 60,
          end_time: appointmentData.end_time || '', // Ensure end_time is included even if empty
        ...
        // Handle error with single response parsing
        if (!response.ok) {
          const errorData = await safelyParseResponse(response);
          const errorMessage =
