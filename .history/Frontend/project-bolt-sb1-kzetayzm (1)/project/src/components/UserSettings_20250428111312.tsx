...
const UserSettings: React.FC = () => {
  ...
  // Wrap fetch functions in useCallback to avoid dependency issues
  ...
  }, [fetchUserProfile, fetchNotificationPreferences]);
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      await API.profile.updateProfile(token, updatedProfile);
