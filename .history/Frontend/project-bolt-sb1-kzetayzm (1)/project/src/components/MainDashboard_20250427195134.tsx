    ...
    try {
      ...
      if (appointmentsPromise.status === 'fulfilled') {
        const appointments = appointmentsPromise.value
          .filter((appt: any) => appt.status === 'scheduled')
          .sort(
            (a: any, b: any) =>
      ...
      // Process mood insights
      if (moodPromise.status === 'fulfilled') {
        const insights = moodPromise.value;
        setMoodSummary({
          averageScore: insights.averageMoodScore || 0,
          recentTrend: insights.recentTrend || 'stable',
          mostCommonMood: insights.mostCommonMood || 'neutral',
        });
      } else {
        setMoodSummary({
          averageScore: 0,
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-indigo-600 text-white rounded-lg shadow-md p-6 flex flex-col">
              <h3 className="text-lg font-medium mb-2">Talk to eSaha</h3>
              <p className="text-indigo-100 mb-4">
                Share your thoughts or get support anytime
              </p>
              <Button
                className="mt-auto bg-white text-indigo-600 hover:bg-indigo-50"
            ...
            <div className="bg-green-600 text-white rounded-lg shadow-md p-6 flex flex-col">
              <h3 className="text-lg font-medium mb-2">Track Your Mood</h3>
              <p className="text-green-100 mb-4">
                Record how you're feeling today
              </p>
              <Button
                className="mt-auto bg-white text-green-600 hover:bg-green-50"
            ...
            <div className="bg-purple-600 text-white rounded-lg shadow-md p-6 flex flex-col">
              <h3 className="text-lg font-medium mb-2">Schedule Session</h3>
              <p className="text-purple-100 mb-4">
                Book a therapy session or check-in
              </p>
              <Button
                className="mt-auto bg-white text-purple-600 hover:bg-purple-50"
