...
interface MoodInsights {
  ...
  recentTrend: 'improving' | 'declining' | 'stable'; // Add missing property
  mostCommonMood: string; // Add missing property
...
const MoodTrackerDashboard: React.FC = () => {
  ...
  const fetchMoodData = async () => {
    ...
    try {
      ...
      setMoodInsights(insightsResponse);
    } catch (err) {
