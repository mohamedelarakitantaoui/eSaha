      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-blue-600 text-white rounded-xl shadow-lg p-6 flex flex-col transition-transform hover:scale-105">
              <h3 className="text-xl font-semibold mb-2">Talk to eSaha</h3>
              <p className="text-blue-100 mb-4">
                Share your thoughts or get support anytime
              </p>
              <Button
                className="mt-auto bg-white text-blue-600 hover:bg-blue-50 font-medium py-2 px-4 rounded-lg transition-colors duration-300"
            ...
            <div className="bg-red-600 text-white rounded-xl shadow-lg p-6 flex flex-col transition-transform hover:scale-105">
              <h3 className="text-xl font-semibold mb-2">Track Your Mood</h3>
              <p className="text-red-100 mb-4">
                Record how you're feeling today
              </p>
              <Button
                className="mt-auto bg-white text-red-600 hover:bg-red-50 font-medium py-2 px-4 rounded-lg transition-colors duration-300"
            ...
            <div className="bg-yellow-600 text-white rounded-xl shadow-lg p-6 flex flex-col transition-transform hover:scale-105">
              <h3 className="text-xl font-semibold mb-2">Schedule Session</h3>
              <p className="text-yellow-100 mb-4">
                Book a therapy session or check-in
              </p>
              <Button
                className="mt-auto bg-white text-yellow-600 hover:bg-yellow-50 font-medium py-2 px-4 rounded-lg transition-colors duration-300"
