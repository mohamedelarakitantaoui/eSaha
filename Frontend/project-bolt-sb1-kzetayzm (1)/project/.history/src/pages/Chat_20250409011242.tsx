...
const SAMPLE_MESSAGES: Message[] = [
  ...
  },
  {
    id: '2',
    senderId: 'user2',
    // Note: Using double quotes to avoid issues with the apostrophe
...
export function Chat() {
  ...
  const currentUserId = 'user1'; // This would come from authentication context in a real app

  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (!newMessage.trim()) return;

    // TODO: Implement message sending logic (e.g., via API call)
    setNewMessage('');
  };
